  ...
  (setq-default
   ...
   org-agenda-custom-commands
    '(("d" "David's planner view"
       ((agenda "")
        (tags-todo "hw-SCHEDULED={.+}"
                   ((org-agenda-overriding-header "Unscheduled Homework")
...
* capture
#+BEGIN_SRC emacs-lisp
  (defvar du/rwl-file-path (concat du/pkb-directory "/3_resources/self_improvement/rwl.org"))
  (setq
