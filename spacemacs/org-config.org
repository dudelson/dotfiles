...
#+BEGIN_SRC emacs-lisp
  ...
  (setq-default
   ...
   org-agenda-files (list (concat org-directory "/current.org"))
   ...
   org-agenda-text-search-extra-files
    (append
      ...
      (sa-find-org-file-recursively (concat org-directory "/kb"))
      (list (concat org-directory "/notnow.org")))
  ...
  (setq-default
    ...
    `(("t" "TODO" entry (file+headline ,(concat org-directory "/current.org") "todo")
      ...
      ("n" "note" entry (file+headline ,(concat org-directory "/current.org") "notes")
        "* %?\n")
      ("d" "dump" entry (file+headline ,(concat org-directory "/current.org") "thoughts")
        "* *[DUMP]* %?\n" :prepend t)
      ;; templates for rwl.org
      ("r" "Templates for stuff to read")
      ("rb" "book" item (file+headline ,(concat org-directory "/kb/rwl.org") "books")
        "- [ ] %?\n" :prepend t)
      ("rp" "paper" item (file+headline ,(concat org-directory "/kb/rwl.org") "papers")
        "- [ ] %?\n" :prepend t)
      ("w" "Templates for stuff to watch")
      ("wm" "movie" item (file+headline ,(concat org-directory "/kb/rwl.org") "movies")
        "- [ ] %?\n" :prepend t)
      ("wt" "TV show" item (file+headline ,(concat org-directory "/kb/rwl.org") "tv shows")
        "- [ ] %?\n" :prepend t)
      ("wa" "anime" item (file+headline ,(concat org-directory "/kb/rwl.org") "anime")
        "- [ ] %?\n" :prepend t)
      ("wv" "video" item (file+headline ,(concat org-directory "/kb/rwl.org") "videos")
        "- [ ] %?\n" :prepend t)
      ("l" "Templates for stuff to listen to")
      ("lm" "music")
      ("lmc" "check out" item (file+headline ,(concat org-directory "/kb/rwl.org") "check out")
        "- [ ] %?\n" :prepend t)
      ("lmd" "download" item (file+headline ,(concat org-directory "/kb/rwl.org") "download")
        "- [ ] %?\n" :prepend t)
      ("lp" "podcast" item (file+headline ,(concat org-directory "/kb/rwl.org") "podcasts")
        "- [ ] %?\n" :prepend t)
...
** deft
#+BEGIN_SRC emacs-lisp
  (setq deft-directory "~/s/doc/org/kb")
#+END_SRC
