...
#+BEGIN_SRC emacs-lisp
  ...
  (defun du/retangle-reload ()
    (interactive)
    (let ((src "/home/dudelson/s/dot/configs/spacemacs/config.org")
          (dst "/home/dudelson/s/dot/configs/spacemacs/config.el"))
      (if (file-exists-p src)
          (org-babel-tangle-file src dst)
        (message "Could not find config.org")))
    (let ((src "/home/dudelson/s/dot/configs/spacemacs/org-config.org")
          (dst "/home/dudelson/s/dot/configs/spacemacs/org-config.el"))
      (if (file-exists-p src)
          (org-babel-tangle-file src dst)
        (message "Could not find org-config.org")))
    (dotspacemacs/sync-configuration-layers)
    (let ((f "/home/dudelson/s/dot/configs/spacemacs/config.el"))
      (if (file-exists-p f)
          (load-file f)
        (message "Could not find config.el")))
    (let ((f "/home/dudelson/s/dot/configs/spacemacs/org-config.el"))
      (if (file-exists-p f)
          (load-file f)
