...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "term", "web", "spc", "irc", "5", "6", "7"}, s, awful.layout.layouts[1])
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
            -- add my homegrown sysmonitor, caffiene, and update notifications widgets
            sysmonitor.widget,
            caffeine.widget,
            update_notifications.widget,
            mykeyboardlayout,
